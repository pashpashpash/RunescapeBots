...
Some of you asked to add pre-compiled versions that you can directly run in Dreambot, you can find them all in the [/ExportedScripts](https://github.com/pashpashpash/RunescapeBots/ExportedScripts) folder.
...
Cuts Yews next to GE. BE WARNED: After exploit-test-botting for 24 hours straight, I got banned while using this script. Use at your own leisure.
